  ...
  module Authorizations
    ...
    module FedenaPluginLoader
      ...
      def self.load_attribute_to_auth_rules
        ...
        FedenaPlugin::AVAILABLE_MODULES.each{|mod| plugin_auth_file_hash["#{Rails.root}/vendor/plugins/#{mod[:name]=="fedena_google_sso" ? "fedena_oauth" : mod[:name]}/#{mod[:auth_file]}"]= mod[:name]}
...
ActiveRecord::Base.class_eval{def assess_truth; true ; end} #check for cce_enabled or icse_enabled irrespective of the load object
