...
FedenaPlugin.register = {
  ...
  :sub_menus=>[{:title=>"manage_books",:controller=>"books",:action=>"index",:target_id=>"fedena_library"},
    ...
    {:title=>"manage_barcode",:controller=>"books",:action=>"manage_barcode",:target_id=>"fedena_library"},
    ...
    {:title=>"manage_book_additional_details",:controller=>"books",:action=>"add_additional_details",:target_id=>"fedena_library"}],
  ...
  :finance=>{:category_name=>"library",:destination=>{:controller=>"library",:action=>"library_report"},:plugin_name=>"fedena_library"},
  ...
  :autosuggest_menuitems=>[
    ...
    {:menu_type => 'link' ,:label => "autosuggest_menu.manage_barcode",:value =>{:controller => :books,:action => :manage_barcode}},
  ...
  :multischool_models=>%w{Book BookMovement BookReservation LibraryCardSetting Tag Tagging BookAdditionalDetail BookAdditionalField BookAdditionalFieldOption}
}

FedenaLibrary.attach_overrides
