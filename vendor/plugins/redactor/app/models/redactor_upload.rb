class RedactorUpload < ActiveRecord::Base
  ...
  has_attached_file :image,
    :url => "/uploads/:class/:id/:attachment/:attachment_fullname",        
...
#  before_create :set_content_type
  ...
  def self.set_content_type(name)
...
#      Paperclip::Attachment.default_options.merge! k=>v
      RedactorUpload.attachment_definitions[:image].merge! k=>v
    end
  end
end
