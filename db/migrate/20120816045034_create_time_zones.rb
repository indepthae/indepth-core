class CreateTimeZones < ActiveRecord::Migration
  ...
  def self.down
	...
	def self.create_default_timezones
      ...
      ["Baker Island Time", "BIT", "-", 43200],
      ["Marquesas Islands Time", "MART", "-", 34200],
      ["Venezuelan Standard Time", "VET", "-", 16200],
      ["Brasilia Time", "BRT", "-", 7200],
      ["Afghanistan Time", "AFT", "+", 16200],
      ["Nepal Time", "NPT", "+", 20700],
      ["Myanmar Time", "MMT", "+", 23400],
      ["Central Western Standard Time", "CWST", "+", 31500],
      ["Australian Central Daylight Time", "ACDT", "+", 37800],
      ["Norfolk Time", "NFT", "+", 41400],
      ["Chatham Standard Time", "CHAST", "+", 45900],
      ["Samoa Standard Time", "SST", "+", 46800],
      ["Line Islands Time", "LINT", "+", 50400],
      ["Venezuelan Standard Time", "VET", "-", 16200]]
