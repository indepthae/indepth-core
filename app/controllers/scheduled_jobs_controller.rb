  ...
  def index
    ...
    unless params[:job_object].nil? and params[:job_type].nil?
      ...
      unless params[:job_type].nil?
        ...
        elsif  params[:job_object]=="HostelFeeCollection"
          @all_jobs.each do|j|
            @jobs.push j if j.payload_object.class.name=="DelayedHostelFeeCollectionJob"
          end
        elsif  params[:job_object]=="CceReportGenerator"
          @all_jobs.each do|j|
            @jobs.push j if j.payload_object.class.name=="CceReportGenerator"
          end
        elsif  params[:job_object]=="TransportFeeCollection"
          @all_jobs.each do|j|
            @jobs.push j if j.payload_object.class.name=="DelayedTransportFeeCollectionJob"
          end
        else
          @all_jobs.each do|j|
            h = j.handler
