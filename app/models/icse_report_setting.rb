class IcseReportSetting < ActiveRecord::Base
  ...
  SETTINGS = ["ReportHeader", "HeaderSpace", "StudentDetail1", "StudentDetail2", "StudentDetail3", "StudentDetail4", "StudentDetail5", "StudentDetail6", "StudentDetail7", "StudentDetail8", "GradingLevel", "GradingLevelPosition" , "Signature", "SignLeftText", "SignCenterText", "SignRightText"]
  ...
  class << self
    ...
    def set_value(key, value)
      ...
      setting.nil? ?
        IcseReportSetting.create(:setting_key => key, :setting_value => value) :
    ...
    def result_as_hash
      records=IcseReportSetting.all(:select=>"setting_key,setting_value")
      if records.present?
      ...
      {"StudentDetail1"=>"st.student_name.full_name",
       "StudentDetail2"=>"st.batch.full_course_name",
       "StudentDetail3"=>"st.adm_no.admission_no"}.merge records
    end
