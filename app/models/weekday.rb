...
#  def self.sort_by_start_day days
#    start_day = Configuration.get_config_value('StartDayOfWeek').try(:to_i)
#    days.sort!
#    day_pos = days.find_index(start_day)
#    end_days = day_pos.present? ? days.shift(day_pos) : []
#    days = end_days.unshift(days).flatten
#    days
#  end
end
