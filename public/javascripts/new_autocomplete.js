...
(function ($) {
    ...
    function fnFormatResult(value, data, currentValue) {
        ...
        if(value.indexOf("<div class") >= 0){
            return value //Do Nothing in case the values contains html tags
        }else{
    ...
    $.fn.newautocompleteAjax = function (options, args) {
        var instance;
    ...
    Autocomplete.prototype = {
        ...
        getSuggestions: function (q) {
            ...
            if (this.options.onSearchStart.call(this.element, this.options.params) === false) {
                return;
            }
            ...
            if (cr && $.isArray(cr.suggestions)) {
                ...
                this.data = cr.data;
                this.options.onSearchComplete.call(this.element, q, this.suggestions);
                this.suggest();
        ...
        change: function (i) {
            ...
            if (selectedValue) {
                s = me.suggestions[i];
                d = me.data[i];
                if(me.getValue(s).indexOf("<div class") >= 0){
                    //Do Nothing in case the values contains html tags
                }else{
