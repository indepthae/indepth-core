...
function ts_makeSortable(t) {
    ...
    for (var i=0;i<firstRow.cells.length;i++) {
        ...
        if (cell.className != "unsortable" && cell.className.indexOf("unsortable") == -1) {
            if (cell.className != "default_row" && cell.className.indexOf("default_row") == -1) {
                ...
                cell.innerHTML = '<a href="#" class="sortheader" onclick="ts_resortTable(this, '+i+');return false;">'+txt+'<span class="sortarrow" sortdir="down">&nbsp;&nbsp;<img src="'+ image_path + image_up + '" alt=""/></span></a>';
            }
        }
    }
